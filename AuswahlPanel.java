...
public class AuswahlPanel extends JPanel {
    ...
    private void ladeLehrerUI() {
        //sqls für die bewerteten und unbewerteten schüler
    ...
    private void ladeSchuelerUI() {
        String sql = "SELECT schuelerId FROM schuelerFragen WHERE schuelerId = \"" + id + "\""    ;
        db.executeStatement(sql);
        String[] bewertet;
        String[] unbewertet;
        if(db.getCurrentQueryResult() != null){
          unbewertet = new String[0];
          bewertet = new String[1];
          bewertet[0] = "Selbsteinschätzung";
        }
        else{
          bewertet = new String[0];
          unbewertet = new String[1];
          unbewertet[0] = "Selbsteinschätzung";
          }

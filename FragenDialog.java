...
public class FragenDialog extends JPanel {
    ...
    public FragenDialog( int istLehrer, String primaerschluessel, DatabaseConnector databaseConnector ) {
        ...
        if ( this.databaseConnector.getErrorMessage() != null ) {
            ...
            fragebogen = new Fragebogen( istLehrer > 0 ? true : false, 260, 0, 740, 600, this.databaseConnector );
            this.add( new AuswahlPanel( istLehrer > 0 ? true : false, primaerschluessel, 0, 0, 260, 600, this.databaseConnector, fragebogen ) );
            this.add( fragebogen );
        }
    }
